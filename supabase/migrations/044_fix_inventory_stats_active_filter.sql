-- Fix get_inventory_stats to only aggregate active inventory rows.
-- Inactive rows (is_active = false) are zero-quantity and should not
-- inflate purchase/selling totals on the dashboard.
